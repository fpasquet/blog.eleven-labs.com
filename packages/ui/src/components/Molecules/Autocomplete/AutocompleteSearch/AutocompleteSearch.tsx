...
import { Box, BoxProps, Flex, Icons, Input, InputProps } from '../../../Atoms';
...
export const AutocompleteSearch: React.FC<AutocompleteSearchProps> = ({
  ...
  <Box
    {...boxProps}
    className={classNames('autocomplete-search', boxProps?.className)}
  >
    <Input
      {...inputProps}
      variant="search"
    ...
    <Flex
      ...
      alignItems="center"
      className="autocomplete-search__button-container"
    >
      {inputProps.value && (
        <button
          {...buttonCloseProps}
          className="autocomplete-search__button-close"
        />
      )}
      <button
        {...buttonSearchProps}
        className="autocomplete-search__button-search"
      >
